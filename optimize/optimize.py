...
testing:
  ...
  reference:
    code:
      owner: sscg13
      sha: 5ad911c1c18ea125661c9eec8c83c862ec089a6d
  ...
  fastchess:
    ...
    sprt:
       ...
       nElo_interval_width: 2
        ...
        print(
            f"transformed {local_exec_id}: {lr} {gamma} {end_lambda} {out_scaling}",
            nElo,
            flush=True,
        )
...
if __name__ == "__main__":
    ...
    remoteNet = RemoteNet(
        environment=environment, max_workers=num_workers, local=False, nElo_target=0
    )
